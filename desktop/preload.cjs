...
contextBridge.exposeInMainWorld('sayagain', {
  state: invoke('state'), setIntegration:invoke('setIntegration'), speechSettings:invoke('speechSettings'), clearApiKey:invoke('clearApiKey'), revealApiKey:invoke('revealApiKey'), synthesize:invoke('synthesize'), cancelSynthesis:invoke('cancelSynthesis'), speechStatus:invoke('speechStatus'), cloudPlatform:invoke('cloudPlatform'),
