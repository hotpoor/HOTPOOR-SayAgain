(function(root){
 ...
 const records=[
  ...
  {id:'freenote',title:'Freenote / PatchxNote 内置样本',label:'PatchxNote 1.0.2（21）· patchnote-standard 0.2.0',model:'同一份官方 SenseVoiceSmall 通用 INT8 模型',file:'model.int8.onnx',bytes:239233841,sha256:commonHash,detail:'Freenote / PatchxNote 也选用了相同的官方通用模型，并将其集成到商业化产品中。已验证的标点等能力在上游模型直接推理中已有体现，不能归因于厂商独立微调。',evidence:'本次核对的内置文件与官方 2024-07-17 通用 INT8 文件完整 SHA-256 相同。仅说明文件一致，不推断产品之间的技术来源关系。',sources:['sherpa','generalDownload']},
